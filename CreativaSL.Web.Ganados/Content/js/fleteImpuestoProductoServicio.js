var FleteImpuestoProductoServicio = function () {
    ...
    var RunEvents = function (){
        $("#btnAddImpuesto").on("click", function () {
            window.location.href = '/Admin/Flete/AC_FleteImpuesto_ProductoServicio?Id1=' + Id1 + '&Id2=' + Id2 + '&Id3=';
        });
       ...
       tblImpuesto = $('#tblImpuesto').DataTable({
            ...
            "ajax": {
                ...
                "url": "/Admin/Flete/TableJsonFleteImpuestoXIdDocDetalle/",
                "type": "POST",
                "datatype": "json",
                "dataSrc": ''
            },
            ...
            "drawCallback": function (settings) {
                $(".editImpuesto").on("click", function () {
                    ...
                    window.location.href = '/Admin/Flete/AC_FleteImpuesto_ProductoServicio?Id1=' + Id1 + '&Id2=' + Id2 + '&Id3=' + IDFleteImpuesto;
                });
