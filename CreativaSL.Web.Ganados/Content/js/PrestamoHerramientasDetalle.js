var PrestamosHDetalle = function () {
    "use strict";
    ...
    var runCombos = function () {
        ...
        $('#IDUnidadProducto').on('change', function (event) {
            ...
            getExistenciaXIDProducto(IdProducto, IdUnidad, IdPrestamo);
        });

        function getUnidadesXIDProducto(IdProducto) {
            $.ajax({
                url: "/Admin/Prestamos/ObtenerUnidadesXIDProducto",
        ...
        function getExistenciaXIDProducto(IdProducto, IdUnidad, IdPrestamo) {
            $.ajax({
                url: "/Admin/Prestamos/ObtenerExistenciaXIDProducto",
                data: { IDProducto: IdProducto, IDPrestamo: IdPrestamo, IDUnidad: IdUnidad },
                async: false,
                dataType: "json",
                type: "POST",
                error: function () {
        ...
        function getUnidadMedidaPrincipalXIDProducto(IdProducto) {
            $.ajax({
                url: "/Admin/Prestamos/ObtenerUnidadMedidaXIDProducto",
                data: { IDProducto: IdProducto },
                async: false,
                dataType: "json",
                type: "POST",
