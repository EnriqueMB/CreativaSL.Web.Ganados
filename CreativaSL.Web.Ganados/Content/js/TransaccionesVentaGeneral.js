var TransaccionesVentaGeneral = function () {
    "use strict";
    //datatables
    ...
    var Load_tablas = function () {
        ...
        tbl_detallesDocumentoPorCobrar = $('#tbl_detallesDocumentoPorCobrar').DataTable({
            ...
            "ajax": {
                ...
                "url": "/Admin/VentaGeneral/DTDetallesDocumentoPorCobrar/",
                "type": "POST",
                "datatype": "json",
                "dataSrc": ''
            },
        ...
        tbl_detallesDocumentoPorCobrarCobros = $('#tbl_detallesDocumentoPorCobrarCobros').DataTable({
            ...
            "ajax": {
                ...
                "url": "/Admin/VentaGeneral/DTDetallesDocumentoPorCobrarCobros/",
                "type": "POST",
                "datatype": "json",
                "dataSrc": ''
            },
                ...
                { "data": "observacion" },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        var menu = "<div class='visible-md visible-lg hidden-sm hidden-xs'>" +
                            ...
                            "<a data-hrefa='/Admin/VentaGeneral/DeleteCobro/' title='Eliminar' data-id='" + full["id_documentoPorCobrarDetallePagos"] + "' class='btn btn-danger tooltips btn-sm deleteCobro' data-placement='top' data-original-title='Eliminar'><i class='fa fa-trash-o'></i></a>" +
                            "</div>" +
                            ...
                            "</li>" +
                            "<li>" +
                            "<a data-hrefa='/Admin/VentaGeneral/DeleteCobro/' class='deleteCobro' role='menuitem' tabindex='-1' data-id='" + full["id_documentoPorCobrarDetallePagos"] + "'>" +
            ...
            "drawCallback": function (settings) {
                $(".editCobro").on("click", function () {
                    ...
                    window.location.href = '/Admin/VentaGeneral/Cobro?&id_1=' + Id + '&id_2=' + Id_detalleDoctoCobrarPago;
                });
        ...
        tbl_detallesDeducciones = $('#tbl_detallesDeducciones').DataTable({
            ...
            "ajax": {
                ...
                "url": "/Admin/VentaGeneral/DTDetallesDocumentoPorCobrarDeducciones/",
                "type": "POST",
                "datatype": "json",
                "dataSrc": ''
            },
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        var menu = "<div class='visible-md visible-lg hidden-sm hidden-xs'>" +
                            "<a data-hrefa='/Admin/VentaGeneral/DeleteDeduccion/' title='Eliminar' data-id='" + full["id_detalleDoctoCobrar"] + "' class='btn btn-danger tooltips btn-sm deleteDeduccion' data-placement='top' data-original-title='Eliminar'><i class='fa fa-trash-o'></i></a>" +
                            "</div>" +
                            "<div class='visible-xs visible-sm hidden-md hidden-lg'>" +
                            "<div class='btn-group'>" +
                            "<a class='btn btn-danger dropdown-toggle btn-sm' data-toggle='dropdown' href='#'" +
                            ...
                            "</a>" +
                            "<ul role='menu' class='dropdown-menu pull-right dropdown-dark'>" +
                            "<a data-hrefa='/Admin/VentaGeneral/DeleteDeduccion/' class='deleteDeduccion' role='menuitem' tabindex='-1' data-id='" + full["id_detalleDoctoCobrar"] + "'>" +
                            "<i class='fa fa-trash-o'></i> Eliminar" +
                            "</a>" +
                            "</li>" +
                            "</ul>" +
    ...
    var EventosCobro = function () {
        $("#btnAddCobro").on("click", function () {
            window.location.href = '/Admin/VentaGeneral/Cobro?id_1=' + Id + '&id_2=';
        });

        $("#btnAddDeduccion").on("click", function () {
            window.location.href = '/Admin/VentaGeneral/Deduccion?id=' + Id_venta;
        });

        $("#btnGenerarComprobante").on("click", function () {
            window.open
                (
                '/Admin/VentaGeneral/Comprobante?id=' + Id,
                '_blank'
                );
        });
