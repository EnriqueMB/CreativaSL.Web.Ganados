var RptProveedorMunicipio = function () {
    "use strict";
    // Funcion para validar registrar
    var runValidator1 = function () {
        var form1 = $('#form-rptPM');
        ...
        $('#form-rptPM').validate({
            ...
            rules: {
                ...
                IDMunicipio: { CMBINT: true },
                
                IDEstado:{ CMBINT: true },
            ...
            messages: {
                ...
                IDMunicipio: { CMBINT: "Seleccione un Municipio." },
                IDEstado: { CMBINT: "Seleccione un Estado." },
