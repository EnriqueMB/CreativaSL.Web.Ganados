            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        if (full["esSistema"] != true) {
                            opcionSistema = "<a data-hrefa='/Admin/DocumentoXPagar/Del_ProductoServicio/' title='Eliminar' data-id='" + full["id_detalleDoctoCobrar"] + "' class='btn btn-danger tooltips btn-sm deleteDetalle' data-placement='top' data-original-title='Eliminar'><i class='fa fa-trash-o'></i></a>";
                            opcionSistemaMin =
                            "<li>" +
                            "<a data-hrefa='/Admin/DocumentoXPagar/Del_ProductoServicio/' class='deleteDetalle' role='menuitem' tabindex='-1' data-id='" + full["id_detalleDoctoCobrar"] + "'>" +
                            "<i class='fa fa-trash-o'></i> Eliminar" +
                            "</a>" +
                            "</li>";
                        }
