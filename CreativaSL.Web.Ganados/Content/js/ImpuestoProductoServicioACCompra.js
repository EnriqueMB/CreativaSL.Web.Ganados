var ImpuestoProductoServicioACCompra = function () {
    "use strict"

    /*INICIA IMPUESTO*/
    var LoadValidationFleteImpuesto = function () {
        var form1 = $('#frm_AC_Impuesto');
        ...
        form1.validate({ // initialize the plugin
            ...
            errorLabelContainer: $("#validation_summary_AC_Impuesto"),
    ...
    function TipoFactor(option) {
        ...
        if (option == 3) {
            ...
            $("#validation_summary_AC_Impuesto").find("dd[for='TasaCuota']").addClass('help-block valid').text('');
            TasaCuota.val("0");
            Importe.val("0");
        }
        else {
