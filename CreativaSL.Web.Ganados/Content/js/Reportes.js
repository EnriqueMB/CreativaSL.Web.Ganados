var Reporte = function () {
    ...
    var runBTN = function () {
        ...
        $("#BTN17").click(function () {
            ...
            var Fin = fecha2;
            if (ban == 1 && ban1 == 1) {
                window.location.href = "/Admin/reportes/RptAlmacen?id=PDF&id2=" + Inicio + "&id3=" + Fin + "&id4=" + IDSucural1;
            }
        });
        $("#BTN18").click(function () {
            ...
            var Fin = fecha2;
            if (ban == 1 && ban1 == 1) {
                window.location.href = "/Admin/reportes/RptEntradaAlmacen?id=PDF&id2=" + Inicio + "&id3=" + Fin + "&id4=" + IDSucural1;
            }
        });
        $("#BTN19").click(function () {
            ...
            var Fin = fecha2;
            if (ban == 1 && ban1 == 1) {
                window.location.href = "/Admin/reportes/RptSalidaAlmacen?id=PDF&id2=" + Inicio + "&id3=" + Fin + "&id4=" + IDSucural1;
            }
        });
        $("#BTN20").click(function () {
            ...
            var Fin = fecha2;
            if (ban == 1 && ban1 == 1) {
                window.location.href = "/Admin/reportes/RptVentaMerma?id=PDF&id2=" + Inicio + "&id3=" + Fin + "&id4=" + IDSucural1;
            }
        });
    };
