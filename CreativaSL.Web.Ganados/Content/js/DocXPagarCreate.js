    ...
    var runValidator1 = function () {
        ...
        $('#form-DocumentoPagar').validate({
            ...
            messages: {
                ...
                IDProveedor: { required: "Seleccione u proveedor" },
                cantidad: { required: "Ingrese una cantidad", min: "Ingrese numeros mayores a 1" },
                precio: { required: "Ingrese una el precio", min: "Ingrese numeros mayores a 1" }
