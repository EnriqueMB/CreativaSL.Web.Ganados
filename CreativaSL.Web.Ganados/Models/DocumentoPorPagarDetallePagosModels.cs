...
{
    public class DocumentoPorPagarDetallePagosModels
    {
        ...
        public string Id_documentoPorPagarDetallePagos { get; set; }
        ...
        public string Id_documentoPorPagarDetallePagosBancarizado { get; set; }
        ...
        public List<DocumentoPorPagarDetallePagosModels> ListaPagosDocumento { get; set; }

        //Datos del cheque para el pago
