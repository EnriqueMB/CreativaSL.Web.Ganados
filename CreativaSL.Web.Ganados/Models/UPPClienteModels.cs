...
namespace CreativaSL.Web.Ganados.Models
{
    public class UPPClienteModels
    {
        ...
        public string ImagenHttp { get; set; }
        ...
        private List<UPPProvedorModels> _listaUPPCliente;

        public List<UPPProvedorModels> listaUPPCliente
        {
            get { return _listaUPPCliente; }
            set { _listaUPPCliente = value; }
        }
